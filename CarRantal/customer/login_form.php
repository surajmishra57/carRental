...
<div class="container">
    <div class="row mt-5">
        ...
        <div class="col-sm-6">
            <h3 class="text-center mb-3"><i class="fa-solid fa-arrow-right-to-bracket"></i> Sign In </h3>
            <form method="post" action="" class="shadow-lg p-3 mb-5 bg-white rounded">
                ...
                <p><small>Don't have account ? <a href="./register_page.php"> click here</a></small></p>
                <?php
                if (isset($regmsg)) {
                    echo $regmsg;
                }
